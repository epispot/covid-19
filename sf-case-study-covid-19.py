...
new_params = epi.fitters.grad_des(get_model_predictions, open('data/formatted/diamond-princess.csv'), parameters,
...
file = open('data/formatted/sf-total-cases.csv').readlines()
