...
optimized_parameters = epi.fitters.grad_des(build_model, open('formatted/sf-hospitalizations.csv'), params_to_build,
...
actual_hos = []
hos_file = open('formatted/sf-hospitalizations.csv', 'r').readlines()
